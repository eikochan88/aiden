...
SETUP_KEYWORDS   = ["サーバー", "サーバー設定", "HP準備", "ホームページ準備", "準備"]
...
def handle_message(event):
    ...
    try:
        ...
        elif any(kw in user_text for kw in SETUP_KEYWORDS):
            reply_text(reply_token, (
                "HPを作るために以下の準備が必要です😊\n\n"
                "【新規でHPを作る場合】\n"
                "👉 https://aiden-1e0e.onrender.com/guide/setup_new.html\n\n"
                "【既存HPに動画を追加する場合】\n"
                "👉 https://aiden-1e0e.onrender.com/guide/setup_existing.html\n\n"
                "ご不明な点はお気軽にLINEでご相談ください！"
            ))
